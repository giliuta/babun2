    ...
    <div className="px-4 pt-3">
      <div className="flex items-center gap-2 px-3 py-3 rounded-xl bg-[rgba(255,149,0,0.08)] border border-[rgba(255,149,0,0.25)]">
        ...
        {askHref && (
          <a
            href={askHref}
            className="h-8 px-3 rounded-lg bg-[var(--system-orange)] text-[var(--label-on-accent)] text-[12px] font-semibold flex items-center active:bg-[var(--system-orange)] flex-shrink-0"
          >
            Спросить
          </a>
        )}
