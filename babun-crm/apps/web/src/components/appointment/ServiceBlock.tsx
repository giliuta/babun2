...
export default function ServiceBlock({
    ...
    return (
      <div className="px-4 pt-3">
        ...
        >
          ...
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-[var(--label-tertiary)]">
  ...
  return (
    <div className="px-4 pt-3">
      ...
      >
        <div className="w-8 h-8 rounded-full bg-[rgba(52,199,89,0.08)] flex items-center justify-center flex-shrink-0 text-[15px]">
          🔧
        </div>
        ...
        <div className="text-right flex-shrink-0">
          <div className="text-[17px] font-bold text-[var(--system-green)] tabular-nums">
            {formatEUR(price)}
          </div>
        </div>
        {!readonly && (
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-[var(--label-tertiary)] flex-shrink-0">
            <polyline points="9 18 15 12 9 6" />
          </svg>
        )}
      </div>
