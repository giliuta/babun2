...
function TeamChip({
  ...
  return (
    <button
      ...
      className={`relative flex items-center px-3 h-8 max-w-[180px] rounded-full text-[12px] font-semibold whitespace-nowrap select-none transition-shadow ${toneClass} ${
        isDragging
