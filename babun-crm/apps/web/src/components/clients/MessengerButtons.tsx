    ...
    <div className="flex items-center gap-1.5 flex-shrink-0">
      {tel && (
        <a
          ...
          className={`${cls} flex items-center justify-center bg-[var(--system-green)] text-[var(--label-on-accent)] active:scale-95 transition`}
        >
      ...
      {wa && (
        <a
          ...
          aria-label="WhatsApp"
          onClick={(e) => e.stopPropagation()}
          className={`${cls} flex items-center justify-center bg-[#25D366] text-[var(--label-on-accent)] active:scale-95 transition`}
        >
      ...
      {tg && (
        <a
          ...
          aria-label="Telegram"
          onClick={(e) => e.stopPropagation()}
          className={`${cls} flex items-center justify-center bg-[#229ED9] text-[var(--label-on-accent)] active:scale-95 transition`}
        >
          <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="currentColor">
      ...
      {ig && (
        <a
          ...
          onClick={(e) => e.stopPropagation()}
          className={`${cls} flex items-center justify-center text-[var(--label-on-accent)] active:scale-95 transition`}
          style={{
            background:
