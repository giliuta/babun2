// Pure inline SVG icons used by ClientPanel. Extracted out of
// ClientPanel.tsx (which was ~2000 lines) — these take no props and
// hold no state, so the move is purely mechanical.
