    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto bg-[var(--surface-grouped)]">
        <div className="max-w-lg mx-auto px-4 py-4 space-y-5 pb-24">
          ...
          {/* v676 — "Выходные дни" picker removed entirely. It caused
              an SSR hydration flash (Sat/Sun columns dimmed → bright
              on every reload) and duplicated the per-day brigade
              schedule, which already has a "сделать день выходным"
              toggle. Sat/Sun stay red in the calendar header by
              weekday alone. */}
