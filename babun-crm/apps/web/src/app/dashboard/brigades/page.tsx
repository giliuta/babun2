          ...
          {(["main", "hours"] as const).map((t) => (
            <button
              ...
              className={`px-3 py-2 text-sm font-medium border-b-2 transition-colors ${
                tab === t ? "border-violet-600 text-violet-700" : "border-transparent text-gray-500"
              }`}
            >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-9 h-5 rounded-full transition-colors ${isActive ? "bg-violet-600" : "bg-gray-300"}`}
                >
                ...
                return (
                  <div key={key} className="flex items-center gap-2 py-1.5 border-b border-gray-50 last:border-0">
                    ...
                    <button
                      ...
                      className={`relative w-8 h-4 rounded-full transition-colors flex-shrink-0 ${day.isWorking ? "bg-violet-600" : "bg-gray-300"}`}
                    >
