...
<path d="M 250 208 L 254 354 C 254 360, 248 360, 246 358 Z" fill="#FFFFFF" opacity="0.22"/>
<ellipse cx="245" cy="378" rx="5.5" ry="6.5" fill="#2A0F1A"/>
<ellipse cx="267" cy="378" rx="5.5" ry="6.5" fill="#2A0F1A"/>
<path d="M 226 410 Q 256 420, 286 410" stroke="#A8482A" stroke-width="3" stroke-linecap="round" fill="none" opacity="0.45"/>
<path d="M 178 232 Q 208 218, 232 234" stroke="#8E5A2E" stroke-width="6" stroke-linecap="round" fill="none" opacity="0.4"/>
<path d="M 280 234 Q 304 218, 334 232" stroke="#8E5A2E" stroke-width="6" stroke-linecap="round" fill="none" opacity="0.4"/>
